...
const Modal = ({ open, onClose, id }: ModalProps) => {
   ...
   return createPortal(
      <>
         ...
         <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col gap-6 max-w-[1094px] w-full max-h-screen h-full px-4 md:px-[67px] py-8 md:pt-16 md:pb-11 rounded-md bg-white border border-solid border-gray-light z-20  overflow-y-auto scrollbar">
            ...
            {isLoading ? (
               ...
               <>
                  ...
                  <div className="flex flex-col md:flex-row gap-[18px] w-full">
                     <div className="basis-2/3 bg-gray-lightest p-7 order-2 md:order-1">
                        <h3 className="text-sb-20 text-gray-dark">{offer?.title}</h3>
                        <br />
                        <p className="text-md-14 text-gray-dark">{offer?.description}</p>
                     </div>
                     <div className="flex flex-col gap-4 basis-1/3 order-1 md:order-2">
                        <div className="flex items-center justify-center px-7 py-4 bg-gray-lightest order-2 md:order-1">
                           <a
                              href={offer?.offerUrl}
                        ...
                        <div className="flex flex-col justify-center grow p-7 bg-gray-lightest order-1 md:order-2">
                           <div className="flex items-center justify-between py-3 md:py-5 first:pt-0 last:pb-0 border-b border-gray-light last:border-none">
